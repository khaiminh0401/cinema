const ItemDefault = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="58" height="55" viewBox="0 0 58 48" fill="none">
...
const ItemChoose = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="58" height="55" viewBox="0 0 57 48" fill="none">
