const ItemDefault = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 57 48" fill="none">
            ...
            <rect x="13.6621" y="39.5404" width="29.2771" height="6.88063" rx="3.44031" fill="#A2A2A2"
                  stroke-width="3"/>
        </svg>
    )
};
...
const ItemCoupleDefault = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 91 48" fill="none">
            ...
            <rect x="13.6624" y="39.5404" width="29.2771" height="6.88063" rx="3.44031" fill="#A2A2A2"
                  stroke-width="3"/>
