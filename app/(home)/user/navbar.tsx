            ...
            <Button
                ...
                <div className='grid grid-rows-2 grid-flow-col gap-x-4 text-white px-2'>
                    <section className='row-span-2 my-auto'>
                        <Avatar
                            src={<img src={"https://th.bing.com/th/id/R.d7800ae0e7bce71f7474026872829021?rik=J9LLGXJjZtfBBw&riu=http%3a%2f%2fwww.arts-wallpapers.com%2fmovie_wallpapers%2fAVATAR-MOVIE%2fimages%2favatar_movie_11.jpg&ehk=9JZC3ur5pdrG0zwiCPRAfAsP9cjGNihKKSuVIdLbPoQ%3d&risl=&pid=ImgRaw&r=0"}
                                alt="avatar" />}
