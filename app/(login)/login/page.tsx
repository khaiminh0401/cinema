                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mt-4">
                            ...
                            <p className='text-sm mt-1 text-red-600 h-5'>{errors.email?.message ? errors.email?.message as string : "(*)"}</p>
                        </div>
                        <div className="mt-4">
                            ...
                            <p className='text-sm mt-1 text-red-600 h-5'>{errors.password?.message ? errors.password?.message as string : "(*)"}</p>
                        </div>
                        <div className="mt-6">
