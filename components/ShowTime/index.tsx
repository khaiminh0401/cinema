...
const ShowTime = ({ children, prop }: any) => {
    ...
    return (
        <>
            {typeof prop === 'string' ? <div className="text-center">Xin lỗi, không có xuất chiếu vào ngày này, hãy chọn một ngày khác.</div> :
                <>
                    ...
                    <div className="mt-4">
                        <div className="justify-content-center d-flex page">
                            {children}
                        </div>
                    </div>
                </>
